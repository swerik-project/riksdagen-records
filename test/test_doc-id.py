...
class DocIdTests(unittest.TestCase):
    ...
    def test_doc_has_id(self):
        ...
        self.assertEqual(0, len(self.no_id), "Some docs have no ID")
    ...
    def test_doc_id_is_filename(self):
        ...
        self.assertEqual(0, len(self.id_not_fn), "Some docs IDs don't match their FN")
    ...
    def test_doc_id_in_dacs(self):
        ...
        self.assertEqual(0, len(self.id_facs_mismatch), "Some docs' IDs don't match the URL in their pb elem facs attribute")
